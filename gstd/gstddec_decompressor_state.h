...
#define GSTDDEC_PROB_TAB_SIZE (1 + GSTDDEC_STATIC_MAX(GSTDDEC_STATIC_MAX(GSTDDEC_STATIC_MAX(GSTD_MAX_HUFFMAN_WEIGHT, GSTD_MAX_OFFSET_CODE), GSTD_MAX_MATCH_LENGTH_CODE), GSTD_MAX_LIT_LENGTH_CODE))
...
{
	uint32_t packedHuffmanWeights[64];	// 8 bits each

	uint32_t probTemps[GSTDDEC_PROB_TAB_SIZE];
...
#define GSTDDEC_FSE_TABLE_CELL_SYM_OFFSET		16
#define GSTDDEC_FSE_TABLE_CELL_SYM_MASK			0xff

#define GSTDDEC_FSE_TABLE_CELL_NUMBITS_OFFSET	24
